<?php
    ...
    class Wmv implements \MimeLib\Interfaces\FileTypeDetectionInterface
    {
        ...
        {
            return Utilities::checkForBytes($targetFile, [0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9]);
        }
        ...
        {
            return new FileType('wmv', 'video/x-ms-wmv');
        }
    }